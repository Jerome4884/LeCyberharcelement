<section class="hero is-fullwidth-with-navbar is-flex is-align-items-center is-justify-content-center imgFond"><!--style="background-image: url('/Applications/MAMP/htdocs/Projet-web-cyberharcelement/hero/assets/background2.jpg');  background-size: cover; height: 100%;"-->
    <div class="container">
            <div class="columns is-centered is-multiline">
                <div class="column is-full">
                    <div class="card" style="background-color: #d4cac170 ;">
                        <div class="card-content is-centered mt-6 mb-6">
                            <div class="card-header">
                                <div class="container has-text-centered">
                                    <h1 class="title has-text-centered" id="titre" >
                                        Comment nous avoir.
                                    </h1>
                                </div>
                            </div>
                            <br>
                            <div class="card-content" style="background-color: #d4cac198; border-radius: 15px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                                <div class="content " style="border-radius: 15px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                                    <div class="content has-text-centered pt-4" id="contentContact" >
                                        <i class="fa-sharp fa-solid fa-location-crosshairs fa-2xl"></i>
                                        <h1 class="title is-3 has-text-centered" id="text">Notre adresse</h1>
